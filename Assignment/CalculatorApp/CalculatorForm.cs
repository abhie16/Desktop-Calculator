...
namespace CalculatorApp
{
    public class CalculatorForm : Form
    {
        ...
        {
            InitializeComponent();
            LoadButtonsFromJson("C:\\Users\\Acer\\Desktop\\task\\abhishek-pandey\\Assignment\\CalculatorApp\\ButtonsSimple.json");
        }
        ...
        private void ToggleModeButton_Click(object sender, EventArgs e)
        {
            ...
            if (_isScientificMode)
            {
                LoadButtonsFromJson("C:\\Users\\Acer\\Desktop\\task\\abhishek-pandey\\Assignment\\CalculatorApp\\ButtonsScientific.json");
            }
            else
            {
                LoadButtonsFromJson("C:\\Users\\Acer\\Desktop\\task\\abhishek-pandey\\Assignment\\CalculatorApp\\ButtonsSimple.json");
